...
function HomeScreen({ navigation, totalTrips, totalEarnings, completedOrders }) {
  return (
    <View style={styles.container}>
      <Text style={styles.totalTripsText}>Total Trips: {totalTrips}</Text>
      <Text style={styles.totalEarningsText}>Total Earnings: {totalEarnings}</Text>
      <Text style={styles.completedOrdersText}>Completed Orders: {completedOrders}</Text>
      ...
      <Image
        source={require('./image-removebg-preview.jpg')}
