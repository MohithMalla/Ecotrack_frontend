    ...
    <View style={styles.container}>
      <View style={styles.infoContainer}>
        <View style={styles.infoLabel}>
          ...
          <Text style={styles.infoText}>Due Amount: {dueAmount}</Text>
        </View>
        <View style={styles.infoRow}>
          <View style={styles.infoSquare}>
            ...
            <Text style={styles.infoValue}>{ordersCompleted}</Text>
          </View>
          <View style={styles.infoSquare}>
            <Icon name="exclamation-circle" size={20} color="#388E3C" style={styles.labelIcon} />
            <Text style={styles.infoText}>Pending</Text>
            <Text style={styles.infoValue}>{ordersPending}</Text>
          </View>
        </View>
      </View>

      <Image
        source={require('./R-removebg-preview.png')}
